...
function sub1() {
    var startTime = document.getElementById("d3").value;
    var endTime = document.getElementById("d4").value;
...
$(document).ready(function () {
    ...
    $("#d3").val(get3MonthBefor());
    $("#d3").blur(function () {
        mashup(this);
    });


    $("#d3").datepicker({ dateFormat: 'yy-mm-dd' });

    // add by zhaodian @ 20130125
    var nextDate = new Date();
    nextDate.setDate(nextDate.getDate() + 1);

    $("#d4").val(nextDate.getFullYear() + '-' + (nextDate.getMonth()+1) + '-' + nextDate.getDate());
    //end
    $("#d4").blur(function () {
        mashup(this);
    });
    ...
    mashup(document.getElementById("d3"));
    mashup(document.getElementById("d4"));
