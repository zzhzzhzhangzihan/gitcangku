...
/*$(function  page() {
    var  content =$("#f_p").val();
    var page = document.getElementsByName("f_p");
      alert(page)
    getjjgg2bulltein(page)

});*/
//紧急公告
$(function () {
    getjjgg2bulltein(1); //加载交易所公告数据
});
function getjjgg2bulltein(pageindex) {
...
function init_jjgg() {
    ...
    $("#go_1").click(function () {
        ...
        getjjgg2bulltein(index);
        return false;
    });
}
function p_i_jjgg(page, total) {
    var retunt = "";
